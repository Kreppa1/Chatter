                    ...
                    switch (param[1]) {
                        ...
                        case "pixel":
                            ...
                            if (param[2].equals("stream")) {
                                ...
                                answer = p.placePixel(Integer.parseInt(param[2]), Integer.parseInt(param[3]), param[4]);
                            else
                                answer = p.placePixel(Integer.parseInt(param[2]), Integer.parseInt(param[3]), Integer.parseInt(param[4]), Integer.parseInt(param[5]), Integer.parseInt(param[6]));
